            ...
            if text:
                ...
                if product_data:
                    ...
                    if duplicate:
                        ...
                        # Atualizar ingredientes se estava vazio
                        if not duplicate.ingredients and ingredients:
                            duplicate.ingredients = ingredients
                            updated = True
                        
                        # Atualizar informações nutricionais se estava vazio
                        if not duplicate.nutritional_info and nutritional_info:
                            duplicate.nutritional_info = nutritional_info
                            updated = True
                        ...
                        if scraping_enabled:
                            try:
                                ...
                                if enriched_data:
                                    ...
                                    # Adicionar ingredientes se não existem
                                    if enriched_data.get('ingredients') and not product.ingredients:
                                        product.ingredients = enriched_data['ingredients']
                                    
                                    # Adicionar informações nutricionais se não existem
                                    if enriched_data.get('nutritional_info') and not product.nutritional_info:
                                        product.nutritional_info = enriched_data['nutritional_info']
