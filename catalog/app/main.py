...
from app.api import catalog, products, admin, search, deduplication, status, health, cobasi_extraction, unified_products
...
app.include_router(unified_products.router, prefix="/api/unified", tags=["unified"])
