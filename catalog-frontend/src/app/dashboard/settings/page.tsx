                        ...
                        <div>
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    rows={4}
                                    className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-md shadow-sm focus:outline-none focus:ring-primary-500 focus:border-primary-500 font-mono text-sm"
                                    placeholder="gsk_key1,gsk_key2,gsk_key3"
                                />
                                {errors.groq_api_keys && (
                                    <p className="mt-1 text-sm text-red-600 dark:text-red-400">{errors.groq_api_keys.message}</p>
                                )}
                            ...
                            <div className="space-y-6">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-md shadow-sm focus:outline-none focus:ring-primary-500 focus:border-primary-500"
                                        placeholder="10"
                                    />
                                ...
                                <div>
                                    ...
                                    />
                                    {errors.scraping_url && (
                                        <p className="mt-1 text-sm text-red-600 dark:text-red-400">{errors.scraping_url.message}</p>
                                    )}
                                    <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
